function juegoNubes(contenedor){
    ...
    const zona = document.getElementById("nubesResponsive");
    ...
    function ajustarPantalla(){
        ...
        if(esVertical){
            ...
            zona.style.paddingTop = "20px";
            zona.style.paddingBottom = "20px";
